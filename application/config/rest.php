...
|
*/
$config['auth_override_class_method']['users']['index']['post'] = true;
$config['auth_override_class_method']['login']['index']['post'] = true;
$config['auth_override_class_method']['register']['index']['get'] = true;
$config['auth_override_class_method']['register']['check'] = true;
$config['auth_override_class_method']['password']['reset'] = true;
$config['auth_override_class_method']['queues']['all'] = true;
$config['auth_override_class_method']['redirect']['all'] = true;
$config['auth_override_class_method']['events']['all'] = true;
...
$config['auth_override_class_method']['accounts']['twitter_callback']['get'] = true;
$config['auth_override_class_method']['accounts']['facebook_callback']['get'] = true;
$config['auth_override_class_method']['accounts']['instagram_callback']['get'] = true;
/*
|--------------------------------------------------------------------------
